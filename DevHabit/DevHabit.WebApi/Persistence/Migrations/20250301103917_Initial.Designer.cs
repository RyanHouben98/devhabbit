...
namespace DevHabit.WebApi.Persistence.Migrations
{
    [DbContext(typeof(ApplicationDbContext))]
    [Migration("20250301103917_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DevHabit.WebApi.Entities.Habit", b =>
                {
            ...
            modelBuilder.Entity("DevHabit.WebApi.Entities.Habit", b =>
                {
                    b.OwnsOne("DevHabit.WebApi.Entities.Frequency", "Frequency", b1 =>
                        {
                    ...
                    b.OwnsOne("DevHabit.WebApi.Entities.Milestone", "Milestone", b1 =>
                        {
                            b1.Property<string>("HabitId")
                                .HasColumnType("character varying(500)")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("DevHabit.WebApi.Entities.Target", "Target", b1 =>
                        {
                            b1.Property<string>("HabitId")
                                .HasColumnType("character varying(500)")
                                .HasColumnName("id");
